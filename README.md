...
```
???????????????     ????????????????     ???????????????????????
?  Telegram    ???????  TG Proxy    ???????  Telegram DC        ?
?  App         ?     ?  SOCKS5      ?     ?  WebSocket Relay     ?
?              ???????  127.0.0.1   ???????  kwsN.web.tg.org    ?
???????????????     ????????????????     ???????????????????????
     TCP              Local proxy           TLS + WebSocket
```
