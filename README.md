...
На **Xiaomi/MIUI**: Настройки → Приложения → TG Proxy → Батарея → Нет ограничений<br>
На **Samsung**: Настройки → Батарея → TG Proxy → Неограниченно<br>
...
| 🌊 | [**Flowseal**](https://github.com/Flowseal) | Оригинальный WS-прокси(v. 1.2.0) |
